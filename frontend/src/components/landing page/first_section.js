            ...
            <div id="firstSection" className="section firstSection row">
                ...
                <div className="block">
                    <div className="content">
                        ...
                        <div className="cont3">
                            <ul>
                                <li> Know the performance of various artists around the world</li>
                                <li> Choose the best you think from the artists</li>
                                <li> Work in a more better way than ever before</li>
                            </ul>
                        </div>
