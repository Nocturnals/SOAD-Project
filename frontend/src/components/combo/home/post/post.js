  ...
  dropDownEventListener = e => {
    document.addEventListener("click", event => {
      ...
      if (
        ...
        this.setState({
          moreOptionsDrop: this.moreOptionsDrop ? false : this.moreOptionsDrop
        });
      }
    });
  };
    ...
    return (
      ...
      >
        <div className="post-header row">
          ...
          <div className="col user-details">
            <div className="row">
              ...
              <div className="more-options col-2">
                ...
                >
                  <i
                    className={
                      "fa fa-ellipsis-v " +
                      (this.state.moreOptionsDrop ? "moColor" : "")
                    }
              ...
              <div
                className={
                  "moreOptions " + (this.state.moreOptionsDrop ? "show" : "")
                }
              >
          ...
          <div className="col">
            <div className="post-descr row">
              <div className="col-12">
                <p>'handleResponse' is defined but never used</p>
              </div>
            </div>
            <div className="row">
              <div
        ...
        <div className="post-impressions row">
          <div className="col">
            <span className={"likes " + (this.state.liked ? "liked" : "")}>
              <i
            ...
            <span className="comments">
              ...
              ></i>
              <button onClick={this.toggleCommentsSection}>400</button>
            </span>
          </div>
        </div>
        <div
          className={
            "commentsSection row " + (this.state.showCmnts ? "show" : "")
          }
        >
          <div className="col">
